...
namespace RagnarokNpcEditor.Classes
{
    ...
    public class MRUManager
    {
        ...
        public MRUManager(ToolStripMenuItem recentFileMenuItem, ClickedHandler clickedHandler)
        ...
        public MRUManager(ToolStripMenuItem recentFileMenuItem, ClickedHandler clickedHandler, int maxEntries)
        ...
        public MRUManager(ToolStripMenuItem recentFileMenuItem, ClickedHandler clickedHandler, string registryKeyName)
        ...
        public MRUManager(ToolStripMenuItem recentFileMenuItem, ClickedHandler clickedHandler, string registryKeyName, bool loadFromRegistry)
        ...
        /// <param labelName="loadFromRegistry">Loads the MRU settings from the registry immediately.</param>
        /// <param labelName="maxEntries">The maximum number of items on the MRU list.</param>
        public MRUManager(ToolStripMenuItem recentFileMenuItem, ClickedHandler clickedHandler, string registryKeyName, bool loadFromRegistry, int maxEntries)
        {
    ...
    /// </remarks>
    public class MRUManagerInline : MRUManager
    {
        ...
        public MRUManagerInline(ToolStripMenuItem owningMenu, ToolStripMenuItem recentFileMenuItem, ClickedHandler clickedHandler, int maxEntries)
            : this(owningMenu, recentFileMenuItem, clickedHandler, null, false, maxEntries)
        {
        }

        public MRUManagerInline(ToolStripMenuItem owningMenu, ToolStripMenuItem recentFileMenuItem, ClickedHandler clickedHandler, string registryKeyName)
            : this(owningMenu, recentFileMenuItem, clickedHandler, registryKeyName, true, 4)
        {
        }

        public MRUManagerInline(ToolStripMenuItem owningMenu, ToolStripMenuItem recentFileMenuItem, ClickedHandler clickedHandler, string registryKeyName, int maxEntries)
        ...
        public MRUManagerInline(ToolStripMenuItem owningMenu, ToolStripMenuItem recentFileMenuItem, ClickedHandler clickedHandler, string registryKeyName, bool loadFromRegistry, int maxEntries)
        {
